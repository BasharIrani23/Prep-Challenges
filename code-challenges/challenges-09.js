...
const arrayToIncrease =   [20, 54, 89, 41]
// -------------------------------------------------------------------------------------------------------
...
const arrayToRound =  [5.4, 5.5 ,6.7, 6.8] 
...
const employeesBonus = (arr) => {
    arr= arr.map((item) => {
        const salaryNumber = Number(item.salary.slice(0, -1));
        item.salary =`${item.workHours > 8 ? salaryNumber + 100 : salaryNumber + 50}$`;
        return item;
    })
    return arr;
}
...
console.log(
    {
        arrInc : arrInc(arrayToIncrease), 
        roundDecimals : roundDecimals(arrayToRound), 
        employeesBonus : employeesBonus(data)
    }
)
// -------------------------------------------------------------------------------------------------------
